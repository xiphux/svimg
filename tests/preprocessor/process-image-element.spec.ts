...
describe('processImageElement', () => {
    ...
    it('returns unmodified if nothing is passed', async () => {
        ...
        expect(await processImageElement(
            '',
            queue as any,
            {
                inputDir: 'static',
    ...
    it('processes element', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" />');
    ...
    it('processes element with webp', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" srcsetwebp="g/img/test1.webp 300w" placeholder="<svg />" src="img/test.jpg" />');
    ...
    it('processes element with avif', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" srcsetavif="g/img/test1.avif 300w" placeholder="<svg />" src="img/test.jpg" />');
    ...
    it('processes element with webp and avif', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" srcsetwebp="g/img/test1.webp 300w" srcsetavif="g/img/test1.avif 300w" placeholder="<svg />" src="img/test.jpg" />');
    ...
    it('processes element with forced pixel width', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" width="150" />');
    ...
    it('ignores non pixel width', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" width="100%" />');
    ...
    it('ignores dynamic width', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" width={width} />');
    ...
    it('processes node with specified quality', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" quality="50" />');
    ...
    it('ignores a non number quality', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" quality="100%" />');
    ...
    it('ignores a dynamic quality', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" placeholder="<svg />" src="img/test.jpg" quality={quality} />');
    ...
    it('skips placeholder if immediate', async () => {
        ...
        )).toEqual('<Image srcset="g/img/test1.jpg 300w" src="img/test.jpg" immediate />');
