...
describe('resizeImage', () => {
    ...
    it('resizes to buffer', async () => {
        ...
        expect(await resizeImage('/in/file.jpg', { width: 300 })).toEqual({ data: true });
    ...
    it('resizes to file', async () => {
        ...
        expect(await resizeImage('/in/file.jpg', { width: 300 }, '/out/file.jpg')).toEqual({ data: true });
    ...
    it('resizes to buffer with quality and height', async () => {
        ...
        expect(await resizeImage('/in/file.jpg', {
            width: 300,
            height: 200,
            quality: 75
        })).toEqual({ data: true });
    ...
    it('resizes to file with quality and height', async () => {
        ...
        expect(await resizeImage('/in/file.jpg', {
            ...
            height: 200,
            quality: 75
        }, '/out/file.jpg')).toEqual({ data: true });
